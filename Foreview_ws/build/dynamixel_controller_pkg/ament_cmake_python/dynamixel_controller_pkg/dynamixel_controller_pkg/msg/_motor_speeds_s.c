...
bool dynamixel_controller_pkg__msg__motor_speeds__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dynamixel_controller_pkg.msg._motor_speeds.MotorSpeeds", full_classname_dest, 54) == 0);
  }
  dynamixel_controller_pkg__msg__MotorSpeeds * ros_message = _ros_message;
  {  // motor_speed1
...
PyObject * dynamixel_controller_pkg__msg__motor_speeds__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("dynamixel_controller_pkg.msg._motor_speeds");
