...
#include "dynamixel_controller_pkg/msg/detail/motor_speeds__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dynamixel_controller_pkg
cdr_serialize(
  const dynamixel_controller_pkg::msg::MotorSpeeds & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dynamixel_controller_pkg::msg::MotorSpeeds & ros_message)
{
  // Member: motor_speed1
  cdr >> ros_message.motor_speed1;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dynamixel_controller_pkg::msg::MotorSpeeds;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dynamixel_controller_pkg::msg::MotorSpeeds *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dynamixel_controller_pkg::msg::MotorSpeeds *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_dynamixel_controller_pkg
const rosidl_message_type_support_t *
get_message_type_support_handle<dynamixel_controller_pkg::msg::MotorSpeeds>()
{
  return &dynamixel_controller_pkg::msg::typesupport_fastrtps_cpp::_MotorSpeeds__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dynamixel_controller_pkg, msg, MotorSpeeds)() {
  return &dynamixel_controller_pkg::msg::typesupport_fastrtps_cpp::_MotorSpeeds__handle;
}
