...
static const _MotorSpeeds_type_support_symbol_names_t _MotorSpeeds_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dynamixel_controller_pkg, msg, MotorSpeeds)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dynamixel_controller_pkg, msg, MotorSpeeds)),
  }
};
...
{
  return &::dynamixel_controller_pkg::msg::rosidl_typesupport_cpp::MotorSpeeds_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dynamixel_controller_pkg, msg, MotorSpeeds)() {
  return get_message_type_support_handle<dynamixel_controller_pkg::msg::MotorSpeeds>();
}
