...
static const _MotorSpeeds_type_support_symbol_names_t _MotorSpeeds_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dynamixel_controller_pkg, msg, MotorSpeeds)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dynamixel_controller_pkg, msg, MotorSpeeds)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dynamixel_controller_pkg, msg, MotorSpeeds)() {
  return &::dynamixel_controller_pkg::msg::rosidl_typesupport_c::MotorSpeeds_message_type_support_handle;
}
