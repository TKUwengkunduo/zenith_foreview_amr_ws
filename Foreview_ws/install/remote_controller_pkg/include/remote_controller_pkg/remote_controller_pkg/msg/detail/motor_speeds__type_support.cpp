...
{
  new (message_memory) remote_controller_pkg::msg::MotorSpeeds(_init);
}

void MotorSpeeds_fini_function(void * message_memory)
{
  auto typed_message = static_cast<remote_controller_pkg::msg::MotorSpeeds *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MotorSpeeds_message_member_array[2] = {
  {
    ...
    offsetof(remote_controller_pkg::msg::MotorSpeeds, motor_speed1),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(remote_controller_pkg::msg::MotorSpeeds, motor_speed2),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MotorSpeeds_message_members = {
  "remote_controller_pkg::msg",  // message namespace
  "MotorSpeeds",  // message name
  2,  // number of fields
  sizeof(remote_controller_pkg::msg::MotorSpeeds),
...
{
  return &::remote_controller_pkg::msg::rosidl_typesupport_introspection_cpp::MotorSpeeds_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, remote_controller_pkg, msg, MotorSpeeds)() {
  return &::remote_controller_pkg::msg::rosidl_typesupport_introspection_cpp::MotorSpeeds_message_type_support_handle;
}
